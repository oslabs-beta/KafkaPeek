...
function Header({ user }) {
  ...
  return (
    <div id="header-container">
      <div id="header-left">
        <ZurauLogo />
        <a href="https://zurau.app" target="_blank" rel="noreferrer">Zurau</a>
      </div>
      <div id="header-mid">
        <div id="header-mid-left">
          <a href="https://zurau.app" target="_blank" rel="noreferrer">
            Documentation
          </a>
        </div>
        <div id="header-mid-right">
          <a href="https://github.com/oslabs-beta/zurau" target="_blank" rel="noreferrer">
            Github
          </a>
        </div>
      </div>
