...
const Header = ({ user }) => {
  ...
  const signinButton = (
    <button>
      <a href='https://zurau.herokuapp.com/auth/github'>{<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-github" viewBox="0 0 16 16">
